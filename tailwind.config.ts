    ...
    extend: {
      colors: {
        ...
        vexo: {
          ...
          secondary: "var(--vexo-secondary)",
          "secondary-container": "var(--vexo-secondary-container)",
          tertiary: "var(--vexo-tertiary)",
          ...
          background: "var(--vexo-background)",
          "on-background": "var(--vexo-on-background)",
          surface: "var(--vexo-surface)",
          "on-surface": "var(--vexo-on-surface)",
          "surface-variant": "var(--vexo-surface-variant)",
          "on-surface-variant": "var(--vexo-on-surface-variant)",
          outline: "var(--vexo-outline)",
          "outline-variant": "var(--vexo-outline-variant)",
          "inverse-surface": "var(--vexo-inverse-surface)",
          "surface-lowest": "var(--vexo-surface-container-lowest)",
          "surface-low": "var(--vexo-surface-container-low)",
          "surface-container": "var(--vexo-surface-container)",
