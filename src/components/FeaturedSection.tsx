      ...
      <div className={`relative z-10 flex justify-center opacity-0 ${isVisible ? 'animate-scale-in' : ''}`} style={{ animationDelay: '0.1s' }}>
        <div className="w-[360px] rounded-2xl overflow-hidden bg-gradient-to-b from-foreground/70 to-foreground/90 shadow-2xl">
          <div className="p-6 pt-5">
            <p className="text-center text-primary-foreground/60 text-xs tracking-[0.3em] uppercase font-medium">VEXO</p>
          ...
          <div className="relative">
            <img src={featuredModel} alt="Featured outfit" className="w-full h-[380px] object-cover object-top" loading="lazy" width={640} height={896} />
